...
def build_pdf(file_in, title, compiled
, template=TEMPLATE, image=IMAGE_NAME):
    ...
    client.containers.run(IMAGE_NAME, command=f'-s -o {tex_file} -V title="{title}" -V compiled="{compiled}" --toc --template={template} {file_in}',
